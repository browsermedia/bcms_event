...
ActiveRecord::Schema.define(:version => 20120524204153) do

  create_table "bcms_event_event_versions", :force => true do |t|
  ...
  create_table "bcms_event_events", :force => true do |t|
    t.integer  "version"
